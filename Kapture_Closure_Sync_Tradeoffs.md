...
| 3 | Quality attribution | **Agent's closure time is the resolution timestamp; the CSP is credited.** | (a) Agent's time but attributed to Wiom — removes the breach but also removes the CSP's credit on 5,526 tickets/month. (b) Exclude these complaints from scoring entirely. | The CSP should be judged on when the fault was actually fixed. This is what converts the 410 wrongly-recorded breaches to on-time. | 17 Sep 2026 |
