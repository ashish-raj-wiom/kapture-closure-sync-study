...
| **Version** — v1.3 · 18 Sep 2026 | **Consulted — Quality OS** — Akhil | | |
...
| T4 | COMPLETED (unacknowledged) | A holder taps ठीक है | Actor is the account owner, a manager on that account, or the assigned technician | COMPLETED (archived **for that person**) | That person's card leaves their feed and is retrievable in their archive (R4a); every other holder's card is untouched and still active (R4 MUST NOT); complaint untouched. |
...
| T6 | COMPLETED (unacknowledged) | C-01 elapses with no acknowledgement from a given holder | — | COMPLETED (archived **for that person**) | That person's card leaves their feed unacknowledged and is retrievable in their archive (R4d); other holders are unaffected; complaint untouched. |
